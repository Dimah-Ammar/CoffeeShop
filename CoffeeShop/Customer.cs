...
namespace CoffeeShop
{
    public partial class Customer : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("update USignup set  Name=@Name, Password=@Password, Address=@Address, Email=@Email, Phone=@Phone, Gender=@Gender where Name=@Name", con);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-1VNNIKF\\SQLEXPRESS01;Initial Catalog=CoffeeShop;Integrated Security=True;TrustServerCertificate=True");
            con.Open();
            SqlCommand cmd = new SqlCommand("Delete USignup where Name=@Name", con);
            cmd.Parameters.AddWithValue("@Name", name_textBox1.Text);
            cmd.ExecuteNonQuery();
            con.Close();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            if (name_textBox1.Text == "")
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-1VNNIKF\\SQLEXPRESS01;Initial Catalog=CoffeeShop;Integrated Security=True;TrustServerCertificate=True");
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from USignup", con);
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                DataTable dt = new DataTable();
                da.Fill(dt);
                dataGridView1.DataSource = dt;
            }
            else if (name_textBox1.Text != "")
            {
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-1VNNIKF\\SQLEXPRESS01;Initial Catalog=CoffeeShop;Integrated Security=True;TrustServerCertificate=True");
                con.Open();
                SqlCommand cmd = new SqlCommand("Select * from USignup where Name= '" + name_textBox1.Text + "'", con);
        ...
        private void email_textBox4_TextChanged(object sender, EventArgs e)
        {
